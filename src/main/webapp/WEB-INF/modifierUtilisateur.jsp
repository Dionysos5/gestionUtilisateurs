<%@page import="forms.AddUserForm"%>

<%
AddUserForm form = (AddUserForm) request.getAttribute("form");
...
<%--   <p class="whitespace-nowrap text-sm">${form.statusMessage}</p>
 --%></span>
      ...
      <div>
        <label for="password" class="text-sm font-medium">Prenom</label>
      ...
      <div>
       ...
       <div>
        <label for="password" class="text-sm font-medium">Confirmer Mot de passe</label>
